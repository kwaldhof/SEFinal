...
new_data = [[1,"WAC",3,3]] #Fetching new record from the frontend (right now I am just set up a record)
...
data.to_excel(writer,sheet_name="Sheet2",startcol=0,startrow=0)#push the data to the excel
