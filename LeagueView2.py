...
class Ui_LeagueView(object):
    ...
    def retranslateUi(self, LeagueView):
        ...
        item.setText(_translate("LeagueView", "1"))
        item = self.tableWidget.verticalHeaderItem(1)
        item.setText(_translate("LeagueView", "2"))
        item = self.tableWidget.verticalHeaderItem(2)
        item.setText(_translate("LeagueView", "3"))
        item = self.tableWidget.verticalHeaderItem(3)
        item.setText(_translate("LeagueView", "4"))
        item = self.tableWidget.verticalHeaderItem(4)
        item.setText(_translate("LeagueView", "5"))
        item = self.tableWidget.verticalHeaderItem(5)
        item.setText(_translate("LeagueView", "6"))
        item = self.tableWidget.verticalHeaderItem(6)
        item.setText(_translate("LeagueView", "7"))
        item = self.tableWidget.verticalHeaderItem(7)
        item.setText(_translate("LeagueView", "9"))
        item = self.tableWidget.verticalHeaderItem(8)
        item.setText(_translate("LeagueView", "10"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("LeagueView", "Team Name"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("LeagueView", "Players"))
        __sortingEnabled = self.tableWidget.isSortingEnabled()
        self.tableWidget.setSortingEnabled(False)
        item = self.tableWidget.item(0, 0)
        item.setText(_translate("LeagueView", "Kyle"))
        item = self.tableWidget.item(0, 1)
        item.setText(_translate("LeagueView", "12"))
        item = self.tableWidget.item(1, 0)
        item.setText(_translate("LeagueView", "Lenny"))
        item = self.tableWidget.item(1, 1)
        item.setText(_translate("LeagueView", "15"))
        item = self.tableWidget.item(2, 0)
        item.setText(_translate("LeagueView", "Zeeta"))
        item = self.tableWidget.item(2, 1)
        item.setText(_translate("LeagueView", "16"))
        item = self.tableWidget.item(3, 0)
        item.setText(_translate("LeagueView", "Tim"))
        item = self.tableWidget.item(3, 1)
        item.setText(_translate("LeagueView", "14"))
        ...
        item.setText(_translate("LeagueView", "Record"))
        item = self.tableWidget_2.horizontalHeaderItem(2)
        item.setText(_translate("LeagueView", "W/L Streak"))
        __sortingEnabled = self.tableWidget_2.isSortingEnabled()
        self.tableWidget_2.setSortingEnabled(False)
        item = self.tableWidget_2.item(0, 0)
        item.setText(_translate("LeagueView", "Kyle"))
        item = self.tableWidget_2.item(0, 1)
        item.setText(_translate("LeagueView", "10-5"))
